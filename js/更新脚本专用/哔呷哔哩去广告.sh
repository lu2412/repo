...
# 2. 设置新的 JSON 内插件描述、更新时间和更新日志日期
NEW_DESCRIPTION="### 插件介绍\n- 净化哔哩哔哩和哔哩哔哩国际版的相关页面与广告\n- 截止目前 8.18.0 版本\n- 插件无设置项安装即可生效"

# 设置为 年月日 格式
UPDATE_DATE="2024年10月27日"  
CURRENT_DATE=$(date +'%Y-%m-%d')  # 设置为 yyyy-mm-dd 格式

# json更新日志书写
CHANGELOG="去除哔哩哔哩和哔哩哔哩国际版的相关页面与广告\n- 截止目前支持 8.18.0 版本\n- > $CURRENT_DATE"

# 3. 目标 control 文件内容
CONTROL_CONTENT="Package: bizhan-Rootless
Name: 哔呷哔哩去广告-Rootless
Version: 1.1.0
Section: 软件增强
...
Author: lym
Description: 插件介绍
 - 去除哔哩哔哩和哔哩哔哩国际版的相关页面与广告
 - 截止目前8.18.0版本
 - 插件无设置项安装即可生效
SileoDepiction: https://raw.githubusercontent.com/liym5238/liym/refs/heads/main/js/bizhan-Rootless.json"
