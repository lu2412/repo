...
NEW_DESCRIPTION="### 插件介绍\n- 屏蔽启动广告｜屏蔽语音录入｜屏蔽弹窗｜屏蔽首页漂浮\n- 屏蔽直播弹窗｜屏蔽搜索栏文字｜屏蔽个人中心横幅\n- 插件无设置项安装即可生效。"
UPDATE_DATE="2024年10月26日"  # 设置为 年月日 格式
CURRENT_DATE=$(date +'%Y-%m-%d')  # 设置为 yyyy-mm-dd 格式
CHANGELOG="发布初始版本支持7.31.0版本\n- > $CURRENT_DATE"

# 3. 目标 control 文件内容
CONTROL_CONTENT="Package: pdd-Rootless
Name: 拼多多去广告-Rootless
Version: 1.0
Section: 软件增强
...
Description: 插件介绍
 - 屏蔽启动广告｜屏蔽语音录入｜屏蔽弹窗｜
 - 屏蔽首页漂浮｜屏蔽直播弹窗｜屏蔽搜索栏文字｜屏蔽个人中心横幅
SileoDepiction: https://raw.githubusercontent.com/liym5238/liym/refs/heads/main/js/pdd-Rootless.json"
