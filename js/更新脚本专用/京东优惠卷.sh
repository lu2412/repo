...
# json更新日志书写
CHANGELOG="启用图表方式显示历史价修复一系列问题\n- 截止目前支持13.6.2版本\n- > $CURRENT_DATE\n ### 版本1.0-0\n- 适配Rootless\n- > $CURRENT_DATE"

# 3. 目标 control 文件内容
CONTROL_CONTENT="Package: jdyhj-Rootless
Name: 京东优惠卷-Rootless
Version: 1.0-1
Section: 软件增强
...
Description: 插件介绍
 ...
 - 截止目前13.6.2版本
 - 插件无设置项安装即可生效
SileoDepiction: https://raw.githubusercontent.com/liym5238/liym/refs/heads/main/js/jdyhj-Rootless.json"
