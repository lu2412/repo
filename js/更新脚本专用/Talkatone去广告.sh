...
# json更新日志书写
CHANGELOG="移除Talkatone烦人的广告\n- 发布初始版本版本\n- > $CURRENT_DATE"

# 3. 目标 control 文件内容
CONTROL_CONTENT="Package: Talkatone-Rootless
Name: Talkatone去广告-Rootless
Version: 0.1
Section: 软件增强
...
Description: 插件介绍
 ...
 - 截止目前6.7.4版本
 - 插件无设置项安装即可生效
SileoDepiction: https://raw.githubusercontent.com/liym5238/liym/refs/heads/main/js/Talkatone-Rootless.json"
