...
# json更新日志书写
CHANGELOG="发布初始版本截止目前支持13.6.2版本\n- > $CURRENT_DATE"

# 3. 目标 control 文件内容
CONTROL_CONTENT="Package: jd-Rootless
Name: 京东去广告-Rootless
Version: 2.0
Section: 软件增强
...
Description: 插件介绍
 ...
 - 截止目前13.6.2版本
 - 插件无设置项安装即可生效
SileoDepiction: https://raw.githubusercontent.com/liym5238/liym/refs/heads/main/js/jd-Rootless.json"
