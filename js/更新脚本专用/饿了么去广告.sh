...
# json更新日志书写
CHANGELOG="精简全能超市和购物车推荐\n- 发布初始版本版本\n- > $CURRENT_DATE"

# 3. 目标 control 文件内容
CONTROL_CONTENT="Package: elm-Rootless
Name: 饿了么去广告-Rootless
Version: 0.1
Section: 软件增强
...
Description: 插件介绍
 ...
 - 插件无设置项安装即可生效
 - 源内所有插件仅供本人学习交流使用，下载后请于24小时内删除!
SileoDepiction: https://raw.githubusercontent.com/liym5238/liym/refs/heads/main/js/elm-Rootless.json"
